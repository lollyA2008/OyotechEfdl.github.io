  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        <i class="icofont-phone"></i> 08162921710
      ...
      <!--
      <div title="English"><a lang="EN" href="#">ENGLISH</a></div>
     &nbsp; &nbsp; / &nbsp; &nbsp;
      <div title="Spanish"><a lang="ES" href="span.php">Español</a></div>
    </div>
  </div>
 -->
  <!-- ======= Header ======= -->
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">STAR</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-left" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>STAR</span></h1>
          <h2>Delivering great food for more than 1 year!</h2>
